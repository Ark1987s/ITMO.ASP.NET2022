<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="Lab03.Ex02.RSVP.Summary" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tbody> <% var yesData = Lab03.Ex02.RSVP.ResponseRepository.GetRepository().GetAllResponses().Where(r => r.WillAttend.Value);
