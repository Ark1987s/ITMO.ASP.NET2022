<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="Lab04.Ex01.RSVP.Summary" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tbody> <% var yesData = Lab04.Ex01.RSVP.ResponseRepository.GetRepository().GetAllResponses().Where(r => r.WillAttend.Value);
